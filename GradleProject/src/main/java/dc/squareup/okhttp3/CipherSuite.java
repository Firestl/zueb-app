...
public final class CipherSuite {
    ...
    public static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: dc.squareup.okhttp3.CipherSuite.1
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = init("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", HashUtils.SECURE_HASH_ALGORITHM_KECCAK_256_RATE);
