...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header("Content-Type"), response.body().contentLength(), Okio.buffer(new Source() { // from class: dc.squareup.okhttp3.internal.cache.CacheInterceptor.1
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        try {
            ...
            if (this.cache != null) {
                if (dc.squareup.okhttp3.internal.http.HttpHeaders.hasBody(responseBuild2) && CacheStrategy.isCacheable(responseBuild2, request)) {
