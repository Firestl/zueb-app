...
public final class HttpUrl {
        ...
        public Builder parse(HttpUrl httpUrl, String str) {
            ...
            if (iSlashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                if (i3 < iDelimiterOffset) {
                    ...
                    this.port = port;
                    if (port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str.substring(i3, iDelimiterOffset) + Operators.QUOTE);
                    }
                } else {
                    this.host = canonicalizeHost(str, i2, iPortColonOffset);
                ...
                if (this.host == null) {
                    throw new IllegalArgumentException("Invalid URL host: \"" + str.substring(i2, iPortColonOffset) + Operators.QUOTE);
                }
    ...
    */
    public static void percentDecode(dc.squareup.okio.Buffer r5, java.lang.String r6, int r7, int r8, boolean r9) {
        /*
        L0:
            if (r7 >= r8) goto L42
