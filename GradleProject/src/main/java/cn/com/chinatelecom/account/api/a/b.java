...
public class b {
    ...
    public static String f1471a = "RSA/ECB/PKCS1Padding";
    ...
    public static byte[] a(RSAPublicKey rSAPublicKey, byte[] bArr) throws Exception {
        if (rSAPublicKey == null) {
            throw new Exception(d.a(new byte[]{-17, g.n, -86, -17, -91, -116, -17, -113, -90, -29, -104, -81, -18, -78, -80, -19, -93, -80, 38, 42, -30, -91, -67, -30, -92, -76, -19, -73, -92}));
        }
        try {
            ...
            throw new Exception(d.a(new byte[]{-17, g.n, -86, -17, -91, -116, -17, -113, -90, -29, -104, -81, -29, -105, -108, -20, -71, -97, 38, -30, -91, -67, -20, -87, -118, -20, -107, -81}));
        } catch (NoSuchAlgorithmException unused2) {
            throw new Exception(d.a(new byte[]{-20, -99, -86, -20, -89, -82, -17, g.n, -86, -17, -91, -116, -19, -92, -99, -20, -71, -97}));
