...
public final class Utils {
    ...
    public static et1 buffer(et1 et1Var) throws IOException {
        Buffer buffer = new Buffer();
        et1Var.source().readAll(buffer);
        return et1.create(et1Var.contentType(), et1Var.contentLength(), buffer);
    }
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        return new IllegalArgumentException(String.format(str, objArr) + "\n    for method " + method.getDeclaringClass().getSimpleName() + Operators.DOT_STR + method.getName(), th);
    }
