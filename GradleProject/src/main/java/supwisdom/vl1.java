...
public class vl1 implements Callback<et1> {
    ...
    public class a extends TimerTask {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ ri1 f9523a;

        public a(vl1 vl1Var, ri1 ri1Var) {
            this.f9523a = ri1Var;
        }
    ...
    public vl1(H5Activity h5Activity, String str, ImageView imageView, TextView textView) {
        this.d = h5Activity;
        this.f9522a = str;
        this.b = imageView;
        this.c = textView;
        ...
        if (et1VarBody != null) {
            try {
                if (new JSONObject(et1VarBody.string()).optInt("code") == 0) {
                    this.d.b0 = this.f9522a.equals("0") ? "1" : "0";
                    this.b.setSelected(this.f9522a.equals("0"));
