...
public final class ob {
    ...
    public static boolean b(ViewParent viewParent, View view, View view2, int i, int i2) {
        if (viewParent instanceof cb) {
            return ((cb) viewParent).a(view, view2, i, i2);
        }
        if (i2 != 0) {
            return false;
        }
        if (Build.VERSION.SDK_INT < 21) {
            if (viewParent instanceof eb) {
                return ((eb) viewParent).onStartNestedScroll(view, view2, i);
            }
            return false;
        }
        try {
    ...
    public static void a(ViewParent viewParent, View view, View view2, int i, int i2) {
        if (viewParent instanceof cb) {
            ((cb) viewParent).b(view, view2, i, i2);
            return;
        }
        if (i2 == 0) {
            if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (viewParent instanceof eb) {
                ((eb) viewParent).onNestedScrollAccepted(view, view2, i);
            }
        }
    }
    ...
    public static void a(ViewParent viewParent, View view, int i) {
        ...
        if (i == 0) {
            ...
            if (viewParent instanceof eb) {
                ((eb) viewParent).onStopNestedScroll(view);
            }
        }
    }

    public static void a(ViewParent viewParent, View view, int i, int i2, int i3, int i4, int i5, int[] iArr) {
        if (viewParent instanceof db) {
            ((db) viewParent).a(view, i, i2, i3, i4, i5, iArr);
            return;
        }
        iArr[0] = iArr[0] + i3;
        iArr[1] = iArr[1] + i4;
        if (viewParent instanceof cb) {
            ((cb) viewParent).a(view, i, i2, i3, i4, i5);
            return;
        }
        if (i5 == 0) {
            if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (viewParent instanceof eb) {
                ((eb) viewParent).onNestedScroll(view, i, i2, i3, i4);
            }
        }
    }
    ...
    public static void a(ViewParent viewParent, View view, int i, int i2, int[] iArr, int i3) {
        if (viewParent instanceof cb) {
            ((cb) viewParent).a(view, i, i2, iArr, i3);
            return;
        }
        if (i3 == 0) {
            if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (viewParent instanceof eb) {
                ((eb) viewParent).onNestedPreScroll(view, i, i2, iArr);
            }
        }
    }
    ...
    public static boolean a(ViewParent viewParent, View view, float f, float f2, boolean z) {
        ...
        if (viewParent instanceof eb) {
            return ((eb) viewParent).onNestedFling(view, f, f2, z);
        }
        return false;
    }
    ...
    public static boolean a(ViewParent viewParent, View view, float f, float f2) {
        ...
        if (viewParent instanceof eb) {
            return ((eb) viewParent).onNestedPreFling(view, f, f2);
        }
        return false;
    }
}
