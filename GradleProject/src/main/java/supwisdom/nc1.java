...
/* JADX INFO: compiled from: MagicHefeFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class nc1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            nc1.this.w[0] = yd1.b(nc1.this.d(), "filter/edgeburn.png");
            nc1.this.w[1] = yd1.b(nc1.this.d(), "filter/hefemap.png");
            nc1.this.w[2] = yd1.b(nc1.this.d(), "filter/hefemetal.png");
            nc1.this.w[3] = yd1.b(nc1.this.d(), "filter/hefesoftlight.png");
        }
    }
