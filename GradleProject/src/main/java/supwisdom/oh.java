...
public class oh {
    ...
    public static final int[] f8671a = {R.attr.name, R.attr.tint, R.attr.height, R.attr.width, R.attr.alpha, R.attr.autoMirrored, R.attr.tintMode, R.attr.viewportWidth, R.attr.viewportHeight};
    ...
    public static final int[] f8672e = {R.attr.drawable};
