...
/* JADX INFO: compiled from: MagicSierraFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class bd1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            bd1.this.w[0] = yd1.b(bd1.this.d(), "filter/sierravignette.png");
            bd1.this.w[1] = yd1.b(bd1.this.d(), "filter/overlaymap.png");
            bd1.this.w[2] = yd1.b(bd1.this.d(), "filter/sierramap.png");
        }
    }
