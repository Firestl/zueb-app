...
public final class kx {
    ...
    public final List<int[]> f8217a = new ArrayList();
    public final List<String> b = new ArrayList();

    public final void a(int[] iArr, String str) {
        this.f8217a.add(iArr);
        this.b.add(str);
    }
    ...
    public final synchronized void a() {
        if (this.f8217a.isEmpty()) {
            ...
            a(new int[]{30, 39}, LocaleManager.DEFAULT_COUNTRY);
            ...
            a(new int[]{745}, "PA");
            a(new int[]{746}, "DO");
            a(new int[]{WXSDKManager.DEFAULT_VIEWPORT_WIDTH}, "MX");
            a(new int[]{754, 755}, "CA");
            a(new int[]{759}, "VE");
            a(new int[]{760, 769}, "CH");
            a(new int[]{UMWorkDispatch.MSG_DELAY_PROCESS}, "CO");
            a(new int[]{773}, "UY");
            a(new int[]{775}, "PE");
            a(new int[]{777}, "BO");
            a(new int[]{779}, "AR");
            a(new int[]{780}, "CL");
            a(new int[]{UMWorkDispatch.MSG_QUIT}, "PY");
            a(new int[]{785}, "PE");
            a(new int[]{786}, "EC");
    ...
    public String a(String str) {
        ...
        for (int i3 = 0; i3 < size && i2 >= (i = (iArr = this.f8217a.get(i3))[0]); i3++) {
            if (iArr.length != 1) {
                i = iArr[1];
            }
            if (i2 <= i) {
