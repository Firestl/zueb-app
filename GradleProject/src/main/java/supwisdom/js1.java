...
public final class js1 {
    ...
    public static final Map<String, js1> c = new LinkedHashMap();
    public static final js1 d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final js1 f8083e;
    ...
    public static final js1 m;
    public static final js1 n;
    public static final js1 o;
    public static final js1 p;
    public static final js1 q;
    public static final js1 r;
    public static final js1 s;
    public static final js1 t;
    public static final js1 u;
    ...
    static {
        ...
        f8083e = a("TLS_RSA_WITH_AES_128_CBC_SHA", 47);
        ...
        a("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", HashUtils.SECURE_HASH_ALGORITHM_KECCAK_256_RATE);
    ...
    public static synchronized js1 a(String str) {
        js1 js1Var;
        js1Var = c.get(str);
        if (js1Var == null) {
            js1Var = c.get(b(str));
    ...
    public static List<js1> a(String... strArr) {
    ...
    public static js1 a(String str, int i2) {
