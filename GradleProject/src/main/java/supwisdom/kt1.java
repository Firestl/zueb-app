...
public final class kt1 {
    ...
    public static final byte[] f8203a;
    public static final String[] b = new String[0];
    public static final et1 c;
    public static final ByteString d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final ByteString f8204e;
    ...
    public class b implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            Thread thread = new Thread(runnable, this.f8205a);
    ...
    static {
        ...
        c = et1.create((xs1) null, bArr);
        ct1.create((xs1) null, f8203a);
        d = ByteString.decodeHex("efbbbf");
        f8204e = ByteString.decodeHex("feff");
    ...
    public static us1 b(List<iu1> list) {
        us1.a aVar = new us1.a();
        for (iu1 iu1Var : list) {
            it1.f7984a.a(aVar, iu1Var.f7988a.utf8(), iu1Var.b.utf8());
        }
        return aVar.a();
    }

    public static String a(vs1 vs1Var, boolean z) {
        String strG;
        if (vs1Var.g().contains(Constants.COLON_SEPARATOR)) {
            strG = Operators.ARRAY_START_STR + vs1Var.g() + Operators.ARRAY_END_STR;
        } else {
            strG = vs1Var.g();
        }
        if (!z && vs1Var.k() == vs1.c(vs1Var.n())) {
            return strG;
        }
        return strG + Constants.COLON_SEPARATOR + vs1Var.k();
    }
    ...
    public static Charset a(BufferedSource bufferedSource, Charset charset) throws IOException {
        ...
        if (bufferedSource.rangeEquals(0L, f8204e)) {
            bufferedSource.skip(f8204e.size());
            return j;
        }
    ...
    */
    public static java.net.InetAddress a(java.lang.String r11, int r12, int r13) {
        ...
        L90:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: supwisdom.kt1.a(java.lang.String, int, int):java.net.InetAddress");
    }
