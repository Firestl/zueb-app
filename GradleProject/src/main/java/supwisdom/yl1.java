...
public class yl1 implements Callback<et1> {
    ...
    public class a extends TimerTask {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ ri1 f9900a;

        public a(yl1 yl1Var, ri1 ri1Var) {
            this.f9900a = ri1Var;
        }
    ...
    public yl1(NewWindowActivity newWindowActivity, String str, ImageView imageView, TextView textView) {
        ...
        if (et1VarBody != null) {
            try {
                if (new JSONObject(et1VarBody.string()).optInt("code") == 0) {
                    this.d.b0 = this.f9899a.equals("0") ? "1" : "0";
                    this.b.setSelected(this.f9899a.equals("0"));
