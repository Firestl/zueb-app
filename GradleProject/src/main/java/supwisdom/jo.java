...
public final class jo implements ko, lo {
    ...
    public final Object a(Object obj) {
        ...
        for (Map.Entry entry : ((Map) obj).entrySet()) {
            ...
            treeMap.put((String) entry.getKey(), ho.b(entry.getValue()));
        }
        return treeMap;
    }
    ...
    public final Object a(Object obj, Type type) {
        ...
        while (itA.hasNext()) {
            ...
            mapA.put(str, oo.a((Class<?>) type3) ? bVar.a(str) : go.a(bVar.a(str), type3));
        }
        return mapA;
    }
