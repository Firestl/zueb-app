        ...
        if (obj instanceof p4) {
            ...
            for (int i = 0; i < this.mSize; i++) {
                try {
                    ...
                    Object obj2 = p4Var.get(kKeyAt);
                    if (vValueAt == null) {
                        if (obj2 != null || !p4Var.containsKey(kKeyAt)) {
                            return false;
                        }
    ...
    public void putAll(p4<? extends K, ? extends V> p4Var) {
        ...
        if (this.mSize != 0) {
            for (int i2 = 0; i2 < i; i2++) {
                put(p4Var.keyAt(i2), p4Var.valueAt(i2));
            }
        } else if (i > 0) {
            System.arraycopy(p4Var.mHashes, 0, this.mHashes, 0, i);
            System.arraycopy(p4Var.mArray, 0, this.mArray, 0, i << 1);
            this.mSize = i;
        }
    }
