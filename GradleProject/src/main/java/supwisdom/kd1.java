...
/* JADX INFO: compiled from: MagicValenciaFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class kd1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            kd1.this.w[0] = yd1.b(kd1.this.d(), "filter/valenciamap.png");
            kd1.this.w[1] = yd1.b(kd1.this.d(), "filter/valenciagradientmap.png");
        }
    }
