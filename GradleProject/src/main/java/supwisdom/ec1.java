...
/* JADX INFO: compiled from: MagicBrooklynFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class ec1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ec1.this.w[0] = yd1.b(ec1.this.d(), "filter/brooklynCurves1.png");
            ec1.this.w[1] = yd1.b(ec1.this.d(), "filter/filter_map_first.png");
            ec1.this.w[2] = yd1.b(ec1.this.d(), "filter/brooklynCurves2.png");
        }
    }
