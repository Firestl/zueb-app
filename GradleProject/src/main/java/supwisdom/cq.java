...
public class cq {
    ...
    public Handler f7239e = new c(Looper.getMainLooper());
    ...
    public class a implements Runnable {
        ...
        public void run() {
            if (cq.this.f7238a == null) {
                cq cqVar = cq.this;
                cq cqVar2 = cq.this;
                cqVar.f7238a = cqVar2.new d(cqVar2.b);
                cq.this.f7238a.setCancelable(cq.this.d);
            }
            try {
                if (cq.this.f7238a.isShowing()) {
                    return;
                }
                cq.this.f7238a.show();
                cq.this.f7239e.sendEmptyMessageDelayed(1, com.igexin.push.config.c.k);
            } catch (Exception e2) {
                vp.a(e2);
            }
        }
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (cq.this.f7238a == null || !cq.this.f7238a.isShowing()) {
                return;
            }
            try {
                cq.this.f7239e.removeMessages(1);
                cq.this.f7238a.dismiss();
            } catch (Exception e2) {
                vp.a(e2);
            }
        }
    ...
    public class d extends AlertDialog {
        ...
        public final View a(Context context) {
            ...
            layoutParams2.setMargins(a(cq.this.b, 17.0f), a(cq.this.b, 10.0f), a(cq.this.b, 8.0f), a(cq.this.b, 10.0f));
            imageView.setLayoutParams(layoutParams2);
            imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageView.setImageDrawable(a(context, cq.f, 480));
            ...
            textView.setText(TextUtils.isEmpty(cq.this.c) ? "正在加载" : cq.this.c);
