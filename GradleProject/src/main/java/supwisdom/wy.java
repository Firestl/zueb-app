...
public final class wy {
    ...
    public static final Object f9681a;
    ...
    static {
        ...
        f9681a = obj;
        b = new Object[][]{new Object[]{"00", 18}, new Object[]{HiAnalyticsConstant.KeyAndValue.NUMBER_01, 14}, new Object[]{"02", 14}, new Object[]{Constants.VIA_REPORT_TYPE_SHARE_TO_QQ, obj, 20}, new Object[]{Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, 6}, new Object[]{Constants.VIA_REPORT_TYPE_SET_AVATAR, 6}, new Object[]{"13", 6}, new Object[]{Constants.VIA_REPORT_TYPE_WPA_STATE, 6}, new Object[]{Constants.VIA_REPORT_TYPE_START_GROUP, 6}, new Object[]{JsContactsMgr.PERMISSION_DENIED_ERROR, 2}, new Object[]{"21", obj, 20}, new Object[]{Constants.VIA_REPORT_TYPE_DATALINE, obj, 29}, new Object[]{"30", obj, 8}, new Object[]{"37", obj, 8}, new Object[]{"90", obj, 30}, new Object[]{"91", obj, 30}, new Object[]{"92", obj, 30}, new Object[]{"93", obj, 30}, new Object[]{"94", obj, 30}, new Object[]{"95", obj, 30}, new Object[]{"96", obj, 30}, new Object[]{"97", obj, 30}, new Object[]{"98", obj, 30}, new Object[]{"99", obj, 30}};
    ...
    public static String a(String str) throws NotFoundException {
        ...
        for (Object[] objArr : b) {
            if (objArr[0].equals(strSubstring)) {
                return objArr[1] == f9681a ? b(2, ((Integer) objArr[2]).intValue(), str) : a(2, ((Integer) objArr[1]).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw NotFoundException.getNotFoundInstance();
        ...
        for (Object[] objArr2 : c) {
            if (objArr2[0].equals(strSubstring2)) {
                return objArr2[1] == f9681a ? b(3, ((Integer) objArr2[2]).intValue(), str) : a(3, ((Integer) objArr2[1]).intValue(), str);
            }
        }
        for (Object[] objArr3 : d) {
            if (objArr3[0].equals(strSubstring2)) {
                return objArr3[1] == f9681a ? b(4, ((Integer) objArr3[2]).intValue(), str) : a(4, ((Integer) objArr3[1]).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw NotFoundException.getNotFoundInstance();
        ...
        for (Object[] objArr4 : f9682e) {
            if (objArr4[0].equals(strSubstring3)) {
                return objArr4[1] == f9681a ? b(4, ((Integer) objArr4[2]).intValue(), str) : a(4, ((Integer) objArr4[1]).intValue(), str);
            }
        }
        throw NotFoundException.getNotFoundInstance();
    }
