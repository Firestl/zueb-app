...
/* JADX INFO: compiled from: MagicLomoFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class tc1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            tc1.this.w[0] = yd1.b(tc1.this.d(), "filter/vlomomap_new.png");
            tc1.this.w[1] = yd1.b(tc1.this.d(), "filter/vignette_map.png");
        }
    }
