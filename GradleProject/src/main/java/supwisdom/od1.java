...
/* JADX INFO: compiled from: MagicXproIIFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class od1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            od1.this.w[0] = yd1.b(od1.this.d(), "filter/xpromap.png");
            od1.this.w[1] = yd1.b(od1.this.d(), "filter/vignettemap_new.png");
        }
    }
