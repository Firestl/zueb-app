...
/* JADX INFO: compiled from: MagicHudsonFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class oc1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            oc1.this.w[0] = yd1.b(oc1.this.d(), "filter/ohudsonbackground.png");
            oc1.this.w[1] = yd1.b(oc1.this.d(), "filter/overlaymap.png");
            oc1.this.w[2] = yd1.b(oc1.this.d(), "filter/hudsonmap.png");
        }
    }
