...
/* JADX INFO: compiled from: MagicWaldenFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class ld1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ld1.this.w[0] = yd1.b(ld1.this.d(), "filter/walden_map.png");
            ld1.this.w[1] = yd1.b(ld1.this.d(), "filter/vignette_map.png");
        }
    }
