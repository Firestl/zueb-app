...
/* JADX INFO: compiled from: MagicAmaroFilter.java */
/* JADX INFO: loaded from: classes2.dex */
public class zb1 extends ud1 {
    public int[] w;
    public int[] x;
    public int y;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            zb1.this.w[0] = yd1.b(zb1.this.d(), "filter/brannan_blowout.png");
            zb1.this.w[1] = yd1.b(zb1.this.d(), "filter/overlaymap.png");
            zb1.this.w[2] = yd1.b(zb1.this.d(), "filter/amaromap.png");
        }
    }
