...
public final class mb {
    ...
    public static Method f8372a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f8372a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f8372a) != null) {
            try {
