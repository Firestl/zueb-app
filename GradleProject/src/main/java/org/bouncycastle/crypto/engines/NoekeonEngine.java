...
public class NoekeonEngine implements BlockCipher {
    public static final int genericSize = 16;
    public static final int[] nullVector = {0, 0, 0, 0};
    public static final int[] roundConstants = {128, 27, 54, 108, JfifUtil.MARKER_SOI, 171, 77, 154, 47, 94, 188, 99, 198, 151, 53, 106, IjkMediaPlayer.MEDIA_VIDEO_DECODER_ERROR};
    public boolean _forEncryption;
    public int[] state = new int[4];
    public int[] subKeys = new int[4];
    public int[] decryptKeys = new int[4];
    public boolean _initialised = false;
