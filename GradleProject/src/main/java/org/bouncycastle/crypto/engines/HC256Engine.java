...
public class HC256Engine implements StreamCipher {
    ...
    public byte[] iv;
    public byte[] key;
    public int[] p = new int[1024];
    public int[] q = new int[1024];
    public int cnt = 0;
    ...
    private int step() {
        ...
        int i2;
        int i3 = this.cnt;
        int i4 = i3 & TXLiteAVCode.EVT_CAMERA_REMOVED;
        if (i3 < 1024) {
            int[] iArr = this.p;
            int i5 = iArr[(i4 - 3) & TXLiteAVCode.EVT_CAMERA_REMOVED];
            int i6 = iArr[(i4 - 1023) & TXLiteAVCode.EVT_CAMERA_REMOVED];
            int i7 = iArr[i4];
            int iRotateRight = iArr[(i4 - 10) & TXLiteAVCode.EVT_CAMERA_REMOVED] + (rotateRight(i6, 23) ^ rotateRight(i5, 10));
            int[] iArr2 = this.q;
            iArr[i4] = i7 + iRotateRight + iArr2[(i5 ^ i6) & TXLiteAVCode.EVT_CAMERA_REMOVED];
            int[] iArr3 = this.p;
            int i8 = iArr3[(i4 - 12) & TXLiteAVCode.EVT_CAMERA_REMOVED];
            i = iArr2[i8 & 255] + iArr2[((i8 >> 8) & 255) + 256] + iArr2[((i8 >> 16) & 255) + 512] + iArr2[((i8 >> 24) & 255) + 768];
            i2 = iArr3[i4];
        } else {
            int[] iArr4 = this.q;
            int i9 = iArr4[(i4 - 3) & TXLiteAVCode.EVT_CAMERA_REMOVED];
            int i10 = iArr4[(i4 - 1023) & TXLiteAVCode.EVT_CAMERA_REMOVED];
            int i11 = iArr4[i4];
            int iRotateRight2 = iArr4[(i4 - 10) & TXLiteAVCode.EVT_CAMERA_REMOVED] + (rotateRight(i10, 23) ^ rotateRight(i9, 10));
            int[] iArr5 = this.p;
            iArr4[i4] = i11 + iRotateRight2 + iArr5[(i9 ^ i10) & TXLiteAVCode.EVT_CAMERA_REMOVED];
            int[] iArr6 = this.q;
            int i12 = iArr6[(i4 - 12) & TXLiteAVCode.EVT_CAMERA_REMOVED];
