...
public class SkeinEngine implements Memoable {
    public static final Hashtable INITIAL_STATES = new Hashtable();
    ...
    public byte[] key;
    public final int outputSizeBytes;
    public Parameter[] postMessageParameters;
    public Parameter[] preMessageParameters;
    public final byte[] singleByte;
    public final ThreefishEngine threefish;
    public final UBI ubi;
    ...
    public class UBI {
        ...
        public long[] message;
        public final UbiTweak tweak = new UbiTweak();
    ...
    public static class UbiTweak {
        public static final long LOW_RANGE = 9223372034707292160L;
        public static final long T1_FINAL = Long.MIN_VALUE;
        public static final long T1_FIRST = 4611686018427387904L;
        public boolean extendedPosition;
        public long[] tweak = new long[2];
    ...
    public static Parameter[] clone(Parameter[] parameterArr, Parameter[] parameterArr2) {
    ...
    public static void initialState(int i, int i2, long[] jArr) {
    ...
    public static void sort(Parameter[] parameterArr) {
        if (parameterArr == null) {
            return;
        }
    ...
    public static Integer variantIdentifier(int i, int i2) {
