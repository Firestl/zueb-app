...
public class RIPEMD320Digest extends GeneralDigest {
    public static final int DIGEST_LENGTH = 40;
    public int H0;
    public int H1;
    public int H2;
    public int H3;
    ...
    public void processBlock() {
        ...
        int iRL65 = RL(iRL28 + f2(iRL63, iRL29, iRL32) + this.X[7] + SHA1Digest.Y1, 7) + iRL30;
        int iRL66 = RL(iRL29, 10);
        int iRL67 = RL(iRL30 + f2(iRL65, iRL63, iRL66) + this.X[4] + SHA1Digest.Y1, 6) + iRL32;
        int iRL68 = RL(iRL63, 10);
        int iRL69 = RL(iRL32 + f2(iRL67, iRL65, iRL68) + this.X[13] + SHA1Digest.Y1, 8) + iRL66;
        int iRL70 = RL(iRL65, 10);
        int iRL71 = RL(iRL66 + f2(iRL69, iRL67, iRL70) + this.X[1] + SHA1Digest.Y1, 13) + iRL68;
        int iRL72 = RL(iRL67, 10);
        int iRL73 = RL(iRL68 + f2(iRL71, iRL69, iRL72) + this.X[10] + SHA1Digest.Y1, 11) + iRL70;
        int iRL74 = RL(iRL69, 10);
        int iRL75 = RL(iRL70 + f2(iRL73, iRL71, iRL74) + this.X[6] + SHA1Digest.Y1, 9) + iRL72;
        int iRL76 = RL(iRL71, 10);
        int iRL77 = RL(iRL72 + f2(iRL75, iRL73, iRL76) + this.X[15] + SHA1Digest.Y1, 7) + iRL74;
        int iRL78 = RL(iRL73, 10);
        int iRL79 = RL(iRL74 + f2(iRL77, iRL75, iRL78) + this.X[3] + SHA1Digest.Y1, 15) + iRL76;
        int iRL80 = RL(iRL75, 10);
        int iRL81 = RL(iRL76 + f2(iRL79, iRL77, iRL80) + this.X[12] + SHA1Digest.Y1, 7) + iRL78;
        int iRL82 = RL(iRL77, 10);
        int iRL83 = RL(iRL78 + f2(iRL81, iRL79, iRL82) + this.X[0] + SHA1Digest.Y1, 12) + iRL80;
        int iRL84 = RL(iRL79, 10);
        int iRL85 = RL(iRL80 + f2(iRL83, iRL81, iRL84) + this.X[9] + SHA1Digest.Y1, 15) + iRL82;
        int iRL86 = RL(iRL81, 10);
        int iRL87 = RL(iRL82 + f2(iRL85, iRL83, iRL86) + this.X[5] + SHA1Digest.Y1, 9) + iRL84;
        int iRL88 = RL(iRL83, 10);
        int iRL89 = RL(iRL84 + f2(iRL87, iRL85, iRL88) + this.X[2] + SHA1Digest.Y1, 11) + iRL86;
        int iRL90 = RL(iRL85, 10);
        int iRL91 = RL(iRL86 + f2(iRL89, iRL87, iRL90) + this.X[14] + SHA1Digest.Y1, 7) + iRL88;
        int iRL92 = RL(iRL87, 10);
        int iRL93 = RL(iRL88 + f2(iRL91, iRL89, iRL92) + this.X[11] + SHA1Digest.Y1, 13) + iRL90;
        int iRL94 = RL(iRL89, 10);
        int iRL95 = RL(iRL90 + f2(iRL93, iRL91, iRL94) + this.X[8] + SHA1Digest.Y1, 12) + iRL92;
        ...
        int iRL129 = RL(iRL92 + f3(iRL95, iRL93, iRL128) + this.X[3] + SHA1Digest.Y2, 11) + iRL94;
        int iRL130 = RL(iRL93, 10);
        int iRL131 = RL(iRL94 + f3(iRL129, iRL95, iRL130) + this.X[10] + SHA1Digest.Y2, 13) + iRL128;
        int iRL132 = RL(iRL95, 10);
        int iRL133 = RL(iRL128 + f3(iRL131, iRL129, iRL132) + this.X[14] + SHA1Digest.Y2, 6) + iRL130;
        int iRL134 = RL(iRL129, 10);
        int iRL135 = RL(iRL130 + f3(iRL133, iRL131, iRL134) + this.X[4] + SHA1Digest.Y2, 7) + iRL132;
        int iRL136 = RL(iRL131, 10);
        int iRL137 = RL(iRL132 + f3(iRL135, iRL133, iRL136) + this.X[9] + SHA1Digest.Y2, 14) + iRL134;
        int iRL138 = RL(iRL133, 10);
        int iRL139 = RL(iRL134 + f3(iRL137, iRL135, iRL138) + this.X[15] + SHA1Digest.Y2, 9) + iRL136;
        int iRL140 = RL(iRL135, 10);
        int iRL141 = RL(iRL136 + f3(iRL139, iRL137, iRL140) + this.X[8] + SHA1Digest.Y2, 13) + iRL138;
        int iRL142 = RL(iRL137, 10);
        int iRL143 = RL(iRL138 + f3(iRL141, iRL139, iRL142) + this.X[1] + SHA1Digest.Y2, 15) + iRL140;
        int iRL144 = RL(iRL139, 10);
        int iRL145 = RL(iRL140 + f3(iRL143, iRL141, iRL144) + this.X[2] + SHA1Digest.Y2, 14) + iRL142;
        int iRL146 = RL(iRL141, 10);
        int iRL147 = RL(iRL142 + f3(iRL145, iRL143, iRL146) + this.X[7] + SHA1Digest.Y2, 8) + iRL144;
        int iRL148 = RL(iRL143, 10);
        int iRL149 = RL(iRL144 + f3(iRL147, iRL145, iRL148) + this.X[0] + SHA1Digest.Y2, 13) + iRL146;
        int iRL150 = RL(iRL145, 10);
        int iRL151 = RL(iRL146 + f3(iRL149, iRL147, iRL150) + this.X[6] + SHA1Digest.Y2, 6) + iRL148;
        int iRL152 = RL(iRL147, 10);
        int iRL153 = RL(iRL148 + f3(iRL151, iRL149, iRL152) + this.X[13] + SHA1Digest.Y2, 5) + iRL150;
        int iRL154 = RL(iRL149, 10);
        int iRL155 = RL(iRL150 + f3(iRL153, iRL151, iRL154) + this.X[11] + SHA1Digest.Y2, 12) + iRL152;
        int iRL156 = RL(iRL151, 10);
        int iRL157 = RL(iRL152 + f3(iRL155, iRL153, iRL156) + this.X[5] + SHA1Digest.Y2, 7) + iRL154;
        int iRL158 = RL(iRL153, 10);
        int iRL159 = RL(iRL154 + f3(iRL157, iRL155, iRL158) + this.X[12] + SHA1Digest.Y2, 5) + iRL156;
        ...
        int iRL193 = RL(iRL188 + f4(iRL159, iRL157, iRL160) + this.X[1] + SHA1Digest.Y3, 11) + iRL158;
        int iRL194 = RL(iRL157, 10);
        int iRL195 = RL(iRL158 + f4(iRL193, iRL159, iRL194) + this.X[9] + SHA1Digest.Y3, 12) + iRL160;
        int iRL196 = RL(iRL159, 10);
        int iRL197 = RL(iRL160 + f4(iRL195, iRL193, iRL196) + this.X[11] + SHA1Digest.Y3, 14) + iRL194;
        int iRL198 = RL(iRL193, 10);
        int iRL199 = RL(iRL194 + f4(iRL197, iRL195, iRL198) + this.X[10] + SHA1Digest.Y3, 15) + iRL196;
        int iRL200 = RL(iRL195, 10);
        int iRL201 = RL(iRL196 + f4(iRL199, iRL197, iRL200) + this.X[0] + SHA1Digest.Y3, 14) + iRL198;
        int iRL202 = RL(iRL197, 10);
        int iRL203 = RL(iRL198 + f4(iRL201, iRL199, iRL202) + this.X[8] + SHA1Digest.Y3, 15) + iRL200;
        int iRL204 = RL(iRL199, 10);
        int iRL205 = RL(iRL200 + f4(iRL203, iRL201, iRL204) + this.X[12] + SHA1Digest.Y3, 9) + iRL202;
        int iRL206 = RL(iRL201, 10);
        int iRL207 = RL(iRL202 + f4(iRL205, iRL203, iRL206) + this.X[4] + SHA1Digest.Y3, 8) + iRL204;
        int iRL208 = RL(iRL203, 10);
        int iRL209 = RL(iRL204 + f4(iRL207, iRL205, iRL208) + this.X[13] + SHA1Digest.Y3, 9) + iRL206;
        int iRL210 = RL(iRL205, 10);
        int iRL211 = RL(iRL206 + f4(iRL209, iRL207, iRL210) + this.X[3] + SHA1Digest.Y3, 14) + iRL208;
        int iRL212 = RL(iRL207, 10);
        int iRL213 = RL(iRL208 + f4(iRL211, iRL209, iRL212) + this.X[7] + SHA1Digest.Y3, 5) + iRL210;
        int iRL214 = RL(iRL209, 10);
        int iRL215 = RL(iRL210 + f4(iRL213, iRL211, iRL214) + this.X[15] + SHA1Digest.Y3, 6) + iRL212;
        int iRL216 = RL(iRL211, 10);
        int iRL217 = RL(iRL212 + f4(iRL215, iRL213, iRL216) + this.X[14] + SHA1Digest.Y3, 8) + iRL214;
        int iRL218 = RL(iRL213, 10);
        int iRL219 = RL(iRL214 + f4(iRL217, iRL215, iRL218) + this.X[5] + SHA1Digest.Y3, 6) + iRL216;
        int iRL220 = RL(iRL215, 10);
        int iRL221 = RL(iRL216 + f4(iRL219, iRL217, iRL220) + this.X[6] + SHA1Digest.Y3, 5) + iRL218;
        int iRL222 = RL(iRL217, 10);
        int iRL223 = RL(iRL218 + f4(iRL221, iRL219, iRL222) + this.X[2] + SHA1Digest.Y3, 12) + iRL220;
