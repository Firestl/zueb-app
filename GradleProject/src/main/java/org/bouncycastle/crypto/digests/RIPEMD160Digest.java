...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        int iRL65 = RL(iRL28 + f2(iRL31, iRL29, iRL32) + this.X[7] + SHA1Digest.Y1, 7) + iRL30;
        int iRL66 = RL(iRL29, 10);
        int iRL67 = RL(iRL30 + f2(iRL65, iRL31, iRL66) + this.X[4] + SHA1Digest.Y1, 6) + iRL32;
        ...
        int iRL129 = RL(iRL92 + f3(iRL95, iRL93, iRL96) + this.X[3] + SHA1Digest.Y2, 11) + iRL94;
        int iRL130 = RL(iRL93, 10);
        int iRL131 = RL(iRL94 + f3(iRL129, iRL95, iRL130) + this.X[10] + SHA1Digest.Y2, 13) + iRL96;
        int iRL132 = RL(iRL95, 10);
        int iRL133 = RL(iRL96 + f3(iRL131, iRL129, iRL132) + this.X[14] + SHA1Digest.Y2, 6) + iRL130;
        ...
        int iRL193 = RL(iRL156 + f4(iRL159, iRL157, iRL160) + this.X[1] + SHA1Digest.Y3, 11) + iRL158;
