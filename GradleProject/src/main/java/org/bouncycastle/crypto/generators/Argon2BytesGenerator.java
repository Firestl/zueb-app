...
public class Argon2BytesGenerator {
    ...
    public static void F(Block block, int i, int i2, int i3, int i4) {
        fBlaMka(block, i, i2);
    ...
    public static void addByteString(Digest digest, byte[] bArr) {
        if (bArr == null) {
    ...
    public static void addIntToLittleEndian(Digest digest, int i) {
    ...
    public static void fBlaMka(Block block, int i, int i2) {
    ...
    private void fillSegment(FillBlock fillBlock, Position position) {
        ...
        if (zIsDataIndependentAddressing) {
            ...
            blockClear2 = fillBlock.zeroBlock.clear();
            blockClear3 = fillBlock.inputBlock.clear();
            initAddressBlocks(fillBlock, position, blockClear2, blockClear3, blockClear);
        } else {
            blockClear = null;
            blockClear2 = null;
            blockClear3 = null;
        ...
        while (position.index < this.segmentLength) {
            int iRotatePrevOffset = rotatePrevOffset(i3, i2);
            long pseudoRandom = getPseudoRandom(fillBlock, position, blockClear, blockClear3, blockClear2, iRotatePrevOffset, zIsDataIndependentAddressing);
            ...
            Block block = blockArr[iRotatePrevOffset];
            Block block2 = blockArr[(this.laneLength * refLane) + refColumn];
    ...
    public static void rotr64(Block block, int i, int i2, long j) {
