...
public class DSAParametersGenerator {
    ...
    public static BigInteger calculateGenerator_FIPS186_3_Verifiable(Digest digest, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr, int i) {
        BigInteger bigIntegerDivide = bigInteger.subtract(ONE).divide(bigInteger2);
    ...
    public static int getMinimumIterations(int i) {
        if (i <= 1024) {
            return 40;
        }
