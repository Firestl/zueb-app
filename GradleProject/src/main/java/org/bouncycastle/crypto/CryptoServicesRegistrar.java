...
public final class CryptoServicesRegistrar {
    ...
    public static final Permission CanSetDefaultProperty = new CryptoServicesPermission(CryptoServicesPermission.GLOBAL_CONFIG);
    public static final Permission CanSetThreadProperty = new CryptoServicesPermission(CryptoServicesPermission.THREAD_LOCAL_CONFIG);
    public static final Permission CanSetDefaultRandom = new CryptoServicesPermission(CryptoServicesPermission.DEFAULT_RANDOM);
    public static final ThreadLocal<Map<String, Object[]>> threadProperties = new ThreadLocal<>();
    public static final Map<String, Object[]> globalProperties = Collections.synchronizedMap(new HashMap());
    ...
    public static int chooseLowerBound(int i) {
        if (i <= 1024) {
            return 160;
        }
        if (i <= 2048) {
    ...
    public static Object[] localClearThreadProperty(Property property) {
    ...
    public static <T> void localSetGlobalProperty(Property property, T... tArr) {
    ...
    public static <T> void localSetThread(Property property, T[] tArr) {
        Map<String, Object[]> map = threadProperties.get();
        if (map == null) {
            map = new HashMap<>();
            threadProperties.set(map);
    ...
    public static Object[] lookupProperty(Property property) {
        Map<String, Object[]> map = threadProperties.get();
