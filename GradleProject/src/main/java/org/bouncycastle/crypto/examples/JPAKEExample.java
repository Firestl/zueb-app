...
public class JPAKEExample {
    public static BigInteger deriveSessionKey(BigInteger bigInteger) {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        System.out.println("");
        System.out.println("(Secret passwords used by Alice and Bob: \"" + Constants.Value.PASSWORD + "\" and \"" + Constants.Value.PASSWORD + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", Constants.Value.PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", Constants.Value.PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
        ...
        System.out.println("KP{x1}={" + jPAKERound1PayloadCreateRound1PayloadToSend.getKnowledgeProofForX1()[0].toString(16) + "};{" + jPAKERound1PayloadCreateRound1PayloadToSend.getKnowledgeProofForX1()[1].toString(16) + Operators.BLOCK_END_STR);
        System.out.println("KP{x2}={" + jPAKERound1PayloadCreateRound1PayloadToSend.getKnowledgeProofForX2()[0].toString(16) + "};{" + jPAKERound1PayloadCreateRound1PayloadToSend.getKnowledgeProofForX2()[1].toString(16) + Operators.BLOCK_END_STR);
        System.out.println("");
        ...
        System.out.println("KP{x3}={" + jPAKERound1PayloadCreateRound1PayloadToSend2.getKnowledgeProofForX1()[0].toString(16) + "};{" + jPAKERound1PayloadCreateRound1PayloadToSend2.getKnowledgeProofForX1()[1].toString(16) + Operators.BLOCK_END_STR);
        System.out.println("KP{x4}={" + jPAKERound1PayloadCreateRound1PayloadToSend2.getKnowledgeProofForX2()[0].toString(16) + "};{" + jPAKERound1PayloadCreateRound1PayloadToSend2.getKnowledgeProofForX2()[1].toString(16) + Operators.BLOCK_END_STR);
        System.out.println("");
        ...
        System.out.println("KP{x2*s}={" + jPAKERound2PayloadCreateRound2PayloadToSend.getKnowledgeProofForX2s()[0].toString(16) + "},{" + jPAKERound2PayloadCreateRound2PayloadToSend.getKnowledgeProofForX2s()[1].toString(16) + Operators.BLOCK_END_STR);
        System.out.println("");
        System.out.println("Bob sends to Alice");
        System.out.println("B=" + jPAKERound2PayloadCreateRound2PayloadToSend2.getA().toString(16));
        System.out.println("KP{x4*s}={" + jPAKERound2PayloadCreateRound2PayloadToSend2.getKnowledgeProofForX2s()[0].toString(16) + "},{" + jPAKERound2PayloadCreateRound2PayloadToSend2.getKnowledgeProofForX2s()[1].toString(16) + Operators.BLOCK_END_STR);
        System.out.println("");
