...
public class ChaCha20Poly1305 implements AEADCipher {
    public static final long AAD_LIMIT = -1;
    public static final int BUF_SIZE = 64;
    public static final long DATA_LIMIT = 274877906880L;
    public static final int KEY_SIZE = 32;
    public static final int MAC_SIZE = 16;
    public static final int NONCE_SIZE = 12;
    public static final byte[] ZEROES = new byte[15];
    public long aadCount;
    public final byte[] buf;
    public int bufPos;
    public final ChaCha7539Engine chacha20;
    public long dataCount;
    public byte[] initialAAD;
    public final byte[] key;
    public final byte[] mac;
    public final byte[] nonce;
    public final Mac poly1305;
    public int state;
