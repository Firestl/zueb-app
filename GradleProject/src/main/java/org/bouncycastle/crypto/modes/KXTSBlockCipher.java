...
public class KXTSBlockCipher extends BufferedBlockCipher {
    public static final long RED_POLY_128 = 135;
    public static final long RED_POLY_256 = 1061;
    public static final long RED_POLY_512 = 293;
    public final int blockSize;
    public int counter;
    public final long reductionPolynomial;
    public final long[] tw_current;
    public final long[] tw_init;
    ...
    public static void GF_double(long j, long[] jArr) {
        long j2 = 0;
        int i = 0;
        while (i < jArr.length) {
            long j3 = jArr[i];
