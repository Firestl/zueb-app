...
public class DEROtherInfo {
    public final DERSequence sequence;

    public static final class Builder {
        public final AlgorithmIdentifier algorithmID;
        public final ASN1OctetString partyUVInfo;
        public final ASN1OctetString partyVInfo;
        public ASN1TaggedObject suppPrivInfo;
        public ASN1TaggedObject suppPubInfo;
