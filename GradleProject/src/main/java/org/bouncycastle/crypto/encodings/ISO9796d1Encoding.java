...
public class ISO9796d1Encoding implements AsymmetricBlockCipher {
    ...
    public static byte[] shadows = {db.l, 3, 5, 8, 9, 4, 2, 15, 0, 13, 11, 6, 7, 10, 12, 1};
    public static byte[] inverse = {8, 15, 6, 1, 5, 2, 11, 12, 3, 4, 13, 10, db.l, 9, 0, 7};

    public ISO9796d1Encoding(AsymmetricBlockCipher asymmetricBlockCipher) {
        this.engine = asymmetricBlockCipher;
    }

    public static byte[] convertOutputDecryptOnly(BigInteger bigInteger) {
