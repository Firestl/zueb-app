...
public class PolynomialGF2mSmallM {
    ...
    public static int headCoefficient(int[] iArr) {
    ...
    public static int[] multWithMonomial(int[] iArr, int i) {
        int iComputeDegree = computeDegree(iArr);
        if (iComputeDegree == -1) {
            return new int[1];
        }
    ...
    public static int[] normalForm(int[] iArr) {
        int iComputeDegree = computeDegree(iArr);
        if (iComputeDegree == -1) {
            return new int[1];
        }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.coefficients.length; i++) {
            str = str + this.field.elementToStr(this.coefficients[i]) + "Y^" + i + Operators.PLUS;
        }
        return str + ";";
    }
}
