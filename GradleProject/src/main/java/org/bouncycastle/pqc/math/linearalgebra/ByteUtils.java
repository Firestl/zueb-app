...
public final class ByteUtils {
    public static final char[] HEX_CHARS = {'0', '1', '2', '3', '4', '5', '6', '7', '8', FunctionParser.Lexer.NINE, FunctionParser.Lexer.A_LOWER, 'b', 'c', 'd', 'e', 'f'};
    ...
    public static byte[] fromHexString(String str) {
        ...
        for (int i4 = 0; i4 < charArray.length; i4++) {
            if (charArray[i4] >= '0' && charArray[i4] <= '9') {
                ...
                bArr[i6] = (byte) (bArr[i6] | ((charArray[i4] - FunctionParser.Lexer.A_UPPER) + 10));
            }
            i3++;
        }
        return bArr;
