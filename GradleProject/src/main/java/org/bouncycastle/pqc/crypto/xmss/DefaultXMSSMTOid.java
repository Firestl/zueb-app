...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    static {
        ...
        map.put(createKey("SHA-512", 64, 16, h.b, 20, 2), new DefaultXMSSMTOid(9, "XMSSMT_SHA2_20/2_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 20, 4), new DefaultXMSSMTOid(10, "XMSSMT_SHA2_20/4_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 40, 2), new DefaultXMSSMTOid(11, "XMSSMT_SHA2_40/2_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 40, 4), new DefaultXMSSMTOid(12, "XMSSMT_SHA2_40/4_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 40, 8), new DefaultXMSSMTOid(13, "XMSSMT_SHA2_40/8_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 60, 3), new DefaultXMSSMTOid(14, "XMSSMT_SHA2_60/3_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 60, 6), new DefaultXMSSMTOid(15, "XMSSMT_SHA2_60/6_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 60, 12), new DefaultXMSSMTOid(16, "XMSSMT_SHA2_60/12_512"));
        ...
        map.put(createKey("SHAKE256", 64, 16, h.b, 20, 2), new DefaultXMSSMTOid(25, "XMSSMT_SHAKE_20/2_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 20, 4), new DefaultXMSSMTOid(26, "XMSSMT_SHAKE_20/4_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 40, 2), new DefaultXMSSMTOid(27, "XMSSMT_SHAKE_40/2_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 40, 4), new DefaultXMSSMTOid(28, "XMSSMT_SHAKE_40/4_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 40, 8), new DefaultXMSSMTOid(29, "XMSSMT_SHAKE_40/8_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 60, 3), new DefaultXMSSMTOid(30, "XMSSMT_SHAKE_60/3_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 60, 6), new DefaultXMSSMTOid(31, "XMSSMT_SHAKE_60/6_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 60, 12), new DefaultXMSSMTOid(32, "XMSSMT_SHAKE_60/12_512"));
