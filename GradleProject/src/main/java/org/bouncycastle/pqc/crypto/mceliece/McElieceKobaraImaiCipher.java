...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    public static final String DEFAULT_PRNG_NAME = "SHA1PRNG";
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        byte[][] bArrSplit3 = ByteUtils.split(bArr6, length2 - PUBLIC_CONSTANT.length);
        byte[] bArr7 = bArrSplit3[0];
