...
public class Treehash {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.tailLength + 6; i++) {
            string = string + getStatInt()[i] + Operators.SPACE_STR;
        }
        ...
        return string + GlideException.IndentedAppendable.INDENT + this.messDigestTree.getDigestSize();
    }
