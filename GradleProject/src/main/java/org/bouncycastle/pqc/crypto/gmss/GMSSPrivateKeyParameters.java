...
public class GMSSPrivateKeyParameters extends GMSSKeyParameters {
    ...
    public Vector[][] currentRetain;
    public byte[][] currentRootSig;
    public byte[][] currentSeeds;
    public Vector[] currentStack;
    public Treehash[][] currentTreehash;
    public GMSSDigestProvider digestProvider;
    public GMSSParameters gmssPS;
    public GMSSRandom gmssRandom;
    public int[] heightOfTrees;
    public int[] index;
    public byte[][][] keep;
    public int mdLength;
    public Digest messDigestTrees;
    public int[] minTreehash;
    public byte[][][] nextAuthPaths;
    public GMSSLeaf[] nextNextLeaf;
    public GMSSRootCalc[] nextNextRoot;
    public byte[][] nextNextSeeds;
    public Vector[][] nextRetain;
    public byte[][] nextRoot;
    public GMSSRootSig[] nextRootSig;
    public Vector[] nextStack;
    public Treehash[][] nextTreehash;
    public int numLayer;
    public int[] numLeafs;
    public int[] otsIndex;
    public GMSSLeaf[] upperLeaf;
    public GMSSLeaf[] upperTreehashLeaf;
    public boolean used;
