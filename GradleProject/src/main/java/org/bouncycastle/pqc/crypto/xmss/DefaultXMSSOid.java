...
public final class DefaultXMSSOid implements XMSSOid {
    ...
    static {
        ...
        map.put(createKey("SHA-512", 64, 16, h.b, 10), new DefaultXMSSOid(4, "XMSS_SHA2_10_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 16), new DefaultXMSSOid(5, "XMSS_SHA2_16_512"));
        map.put(createKey("SHA-512", 64, 16, h.b, 20), new DefaultXMSSOid(6, "XMSS_SHA2_20_512"));
        ...
        map.put(createKey("SHAKE256", 64, 16, h.b, 10), new DefaultXMSSOid(10, "XMSS_SHAKE_10_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 16), new DefaultXMSSOid(11, "XMSS_SHAKE_16_512"));
        map.put(createKey("SHAKE256", 64, 16, h.b, 20), new DefaultXMSSOid(12, "XMSS_SHAKE_20_512"));
    ...
    public static String createKey(String str, int i, int i2, int i3, int i4) {
        if (str == null) {
