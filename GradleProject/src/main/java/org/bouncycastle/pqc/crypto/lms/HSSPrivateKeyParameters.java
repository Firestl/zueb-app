...
public class HSSPrivateKeyParameters extends LMSKeyParameters {
    ...
    public static HSSPrivateKeyParameters makeCopy(HSSPrivateKeyParameters hSSPrivateKeyParameters) {
        try {
    ...
    public HSSPrivateKeyParameters extractKeyShard(int i) {
        ...
        synchronized (this) {
            ...
            long j3 = this.index;
            this.index += j;
            hSSPrivateKeyParametersMakeCopy = makeCopy(new HSSPrivateKeyParameters(this.l, new ArrayList(getKeys()), new ArrayList(getSig()), j3, j2, true));
            resetKeyToIndex();
        }
