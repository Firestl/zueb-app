...
public class GMSSRootCalc {
    ...
    public int heightOfNextSeed;
    public Vector heightOfNodes;
    public int heightOfTree;
    public int[] index;
    public int indexForNextSeed;
    ...
    public byte[] root;
    public Vector tailStack;
    public Treehash[] treehash;
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.heightOfTree + 1 + size; i2++) {
            str = str + new String(Hex.encode(getStatByte()[i2])) + Operators.SPACE_STR;
        }
        return str + GlideException.IndentedAppendable.INDENT + this.digestProvider.get().getDigestSize();
    }
