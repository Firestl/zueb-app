...
public class HashFunctions {
    public static final byte[] hashc = Strings.toByteArray("expand 32-byte to 64-byte state!");
    public final Digest dig256;
    public final Digest dig512;
    public final Permute perm;
