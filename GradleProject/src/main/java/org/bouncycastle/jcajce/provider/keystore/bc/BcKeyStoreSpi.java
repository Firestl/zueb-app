...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    public static final String KEY_CIPHER = "PBEWithSHAAnd3-KeyTripleDES-CBC";
    public static final int KEY_PRIVATE = 0;
    public static final int KEY_PUBLIC = 1;
    public static final int KEY_SALT_SIZE = 20;
    ...
    public static final String STORE_CIPHER = "PBEWithSHAAndTwofish-CBC";
    public static final int STORE_SALT_SIZE = 20;
    ...
    public static class BouncyCastleStore extends BcKeyStoreSpi {
        ...
        public void engineStore(OutputStream outputStream, char[] cArr) throws IOException {
            ...
            int iNextInt = (this.random.nextInt() & TXLiteAVCode.EVT_CAMERA_REMOVED) + 1024;
    ...
    public class StoreEntry {
        ...
        public StoreEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws Exception {
            ...
            int iNextInt = (BcKeyStoreSpi.this.random.nextInt() & TXLiteAVCode.EVT_CAMERA_REMOVED) + 1024;
    ...
    public Key decodeKey(DataInputStream dataInputStream) throws IOException {
        ...
        if (utf.equals("PKCS#8") || utf.equals("PKCS8")) {
            ...
            if (!utf.equals("X.509") && !utf.equals(SecureX509TrustManager.f)) {
                if (utf.equals("RAW")) {
