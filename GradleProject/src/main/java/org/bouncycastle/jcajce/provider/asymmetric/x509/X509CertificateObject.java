...
public class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    public PKCS12BagAttributeCarrier attrCarrier;
    ...
    public static BasicConstraints createBasicConstraints(Certificate certificate) throws CertificateParsingException {
        try {
    ...
    public static boolean[] createKeyUsage(Certificate certificate) throws CertificateParsingException {
        try {
    ...
    public static String createSigAlgName(Certificate certificate) throws CertificateParsingException {
        try {
    ...
    public static byte[] createSigAlgParams(Certificate certificate) throws CertificateParsingException {
        try {
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            ...
            X509CertificateInternal x509CertificateInternal2 = new X509CertificateInternal(this.bcHelper, this.c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, encoded);
            synchronized (this.cacheLock) {
                if (this.internalCertificateValue == null) {
