...
public class PrincipalUtils {
    ...
    public static byte[] getEncoded(X500Principal x500Principal) {
    ...
    public static TrustAnchor notNull(TrustAnchor trustAnchor) {
        if (trustAnchor != null) {
            return trustAnchor;
        }
    ...
    public static X509CRL notNull(X509CRL x509crl) {
        if (x509crl != null) {
            return x509crl;
        }
        throw new IllegalStateException();
    ...
    public static X509Certificate notNull(X509Certificate x509Certificate) {
    ...
    public static X500Principal notNull(X500Principal x500Principal) {
    ...
    public static X500Name notNull(X500Name x500Name) {
        if (x500Name != null) {
            return x500Name;
        }
        throw new IllegalStateException();
