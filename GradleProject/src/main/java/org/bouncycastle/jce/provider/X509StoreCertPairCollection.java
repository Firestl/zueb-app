...
public class X509StoreCertPairCollection extends X509StoreSpi {
    ...
    public void engineInit(X509StoreParameters x509StoreParameters) {
        ...
        throw new IllegalArgumentException("Initialization parameters must be an instance of " + X509CollectionStoreParameters.class.getName() + Operators.DOT_STR);
    }
}
