...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    public static String info = "BouncyCastle Security Provider v1.65";
    ...
    public static final String[] ASYMMETRIC_GENERIC = {SecureX509TrustManager.f, "IES"};
    public static final String[] ASYMMETRIC_CIPHERS = {"DSA", "DH", "EC", "RSA", "GOST", "ECGOST", "ElGamal", "DSTU4145", "GM", "EdEC"};
    public static final String[] DIGESTS = {"GOST3411", "Keccak", "MD2", "MD4", Md5Utils.ALGORITHM, "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "SHA3", "Skein", "SM3", "Tiger", "Whirlpool", "Blake2b", "Blake2s", "DSTU7564", "Haraka"};
