...
public class PEMUtil {
    ...
    public PEMUtil(String str) {
        this._header1 = "-----BEGIN " + str + PemKeyType.MARKER;
        this._header2 = "-----BEGIN X509 " + str + PemKeyType.MARKER;
        this._footer1 = "-----END " + str + PemKeyType.MARKER;
        this._footer2 = "-----END X509 " + str + PemKeyType.MARKER;
    }
