...
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    public static Hashtable keyAlgorithms = new Hashtable();
    ...
    */
    ...
    public static X509Name convertName(X500Principal x500Principal) {
        try {
    ...
    public static RSASSAPSSparams creatPSSParams(AlgorithmIdentifier algorithmIdentifier, int i) {
    ...
    public static ASN1Sequence toDERSequence(byte[] bArr) {
        try {
