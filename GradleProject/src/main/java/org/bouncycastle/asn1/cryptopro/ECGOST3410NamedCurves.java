...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_A, new ECDomainParameters(eCCurveConfigureCurve, configureBasepoint(eCCurveConfigureCurve, new BigInteger("1"), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger2, ECConstants.ONE));
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchA, new ECDomainParameters(eCCurveConfigureCurve2, configureBasepoint(eCCurveConfigureCurve2, new BigInteger("1"), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger4, ECConstants.ONE));
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_B, new ECDomainParameters(eCCurveConfigureCurve3, configureBasepoint(eCCurveConfigureCurve3, new BigInteger("1"), new BigInteger("28792665814854611296992347458380284135028636778229113005756334730996303888124")), bigInteger6, ECConstants.ONE));
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchB, new ECDomainParameters(eCCurveConfigureCurve4, configureBasepoint(eCCurveConfigureCurve4, new BigInteger("0"), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger8, ECConstants.ONE));
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_C, new ECDomainParameters(eCCurveConfigureCurve5, configureBasepoint(eCCurveConfigureCurve5, new BigInteger("0"), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger10, ECConstants.ONE));
    ...
    public static ECPoint configureBasepoint(ECCurve eCCurve, BigInteger bigInteger, BigInteger bigInteger2) {
