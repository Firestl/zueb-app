...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = id_fieldType.branch("2");
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = ansi_X9_62.branch("4");
        id_ecSigType = aSN1ObjectIdentifierBranch3;
        ecdsa_with_SHA1 = aSN1ObjectIdentifierBranch3.branch("1");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch4 = ansi_X9_62.branch("2");
        id_publicKeyType = aSN1ObjectIdentifierBranch4;
        id_ecPublicKey = aSN1ObjectIdentifierBranch4.branch("1");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = id_ecSigType.branch("3");
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch6 = ansi_X9_62.branch("3");
        ...
        c2tnb191v2 = cTwoCurve.branch(Constants.VIA_SHARE_TYPE_INFO);
        c2tnb191v3 = cTwoCurve.branch("7");
        c2onb191v4 = cTwoCurve.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        c2onb191v5 = cTwoCurve.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        c2pnb208w1 = cTwoCurve.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        c2tnb239v1 = cTwoCurve.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        c2tnb239v2 = cTwoCurve.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        c2tnb239v3 = cTwoCurve.branch("13");
        c2onb239v4 = cTwoCurve.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        c2onb239v5 = cTwoCurve.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
        c2pnb272w1 = cTwoCurve.branch(Constants.VIA_REPORT_TYPE_START_WAP);
        c2pnb304w1 = cTwoCurve.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        c2tnb359v1 = cTwoCurve.branch("18");
        c2pnb368w1 = cTwoCurve.branch(Constants.VIA_ACT_TYPE_NINETEEN);
        c2tnb431r1 = cTwoCurve.branch(JsContactsMgr.PERMISSION_DENIED_ERROR);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch8 = ellipticCurve.branch("1");
        ...
        prime239v3 = primeCurve.branch(Constants.VIA_SHARE_TYPE_INFO);
        ...
        mqvSinglePass_sha1kdf_scheme = x9_63_scheme.branch(Constants.VIA_REPORT_TYPE_START_WAP);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch9 = ansi_X9_42.branch("3");
        ...
        dhHybridOneFlow = x9_42_schemes.branch(Constants.VIA_SHARE_TYPE_INFO);
        mqv2 = x9_42_schemes.branch("7");
        mqv1 = x9_42_schemes.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        ...
        id_kdf_kdf3 = x9_44_components.branch("2");
    }
}
