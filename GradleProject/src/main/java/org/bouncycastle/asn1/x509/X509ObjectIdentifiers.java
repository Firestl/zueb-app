...
public interface X509ObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = id_pkix.branch("48");
        id_ad = aSN1ObjectIdentifierBranch;
        id_ad_caIssuers = aSN1ObjectIdentifierBranch.branch("2").intern();
        ASN1ObjectIdentifier aSN1ObjectIdentifierIntern = id_ad.branch("1").intern();
        id_ad_ocsp = aSN1ObjectIdentifierIntern;
        ocspAccessMethod = aSN1ObjectIdentifierIntern;
