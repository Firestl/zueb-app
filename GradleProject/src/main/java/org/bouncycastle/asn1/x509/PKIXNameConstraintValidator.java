...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    public Set permittedSubtreesOtherName;
    ...
    public Set excludedSubtreesOtherName = new HashSet();
    ...
    private void intersectEmail(String str, String str2, Set set) {
        if (str.indexOf(64) != -1) {
            ...
            } else if (str2.startsWith(Operators.DOT_STR)) {
    ...
    private boolean isUriConstrained(String str, String str2) {
        ...
        return !str2.startsWith(Operators.DOT_STR) ? strExtractHostFromURL.equalsIgnoreCase(str2) : withinDomain(strExtractHostFromURL, str2);
    }
