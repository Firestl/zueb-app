...
public class V2TBSCertListGenerator {
    public static final ASN1Sequence[] reasons;
    ...
    public ASN1EncodableVector crlentries = new ASN1EncodableVector();
    ...
    public static ASN1Sequence createInvalidityDateExtension(ASN1GeneralizedTime aSN1GeneralizedTime) {
    ...
    public static ASN1Sequence createReasonExtension(int i) {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(2);
