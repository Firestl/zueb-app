...
public class X509Name extends ASN1Object {
    ...
    static {
        ...
        DefaultSymbols.put(O, DeviceId.CUIDInfo.I_FIXED);
        ...
        DefaultSymbols.put(EmailAddress, QLog.TAG_REPORTLEVEL_USER);
        ...
        RFC2253Symbols.put(O, DeviceId.CUIDInfo.I_FIXED);
        ...
        RFC1779Symbols.put(O, DeviceId.CUIDInfo.I_FIXED);
        ...
        DefaultLookUp.put(CountryCodeBean.SPECIAL_COUNTRYCODE_CN, CN);
    ...
    public X509Name(boolean z, Hashtable hashtable, String str, X509NameEntryConverter x509NameEntryConverter) {
        ...
        while (x509NameTokenizer.hasMoreTokens()) {
            ...
            if (strNextToken.indexOf(43) > 0) {
                X509NameTokenizer x509NameTokenizer2 = new X509NameTokenizer(strNextToken, FunctionParser.Lexer.PLUS);
    ...
    public String toString(boolean z, Hashtable hashtable) {
        ...
        for (int i = 0; i < this.ordering.size(); i++) {
            if (((Boolean) this.added.elementAt(i)).booleanValue()) {
                stringBuffer2.append(FunctionParser.Lexer.PLUS);
