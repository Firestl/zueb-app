...
public class RevRepContentBuilder {
    public ASN1EncodableVector status = new ASN1EncodableVector();
    public ASN1EncodableVector revCerts = new ASN1EncodableVector();
    public ASN1EncodableVector crls = new ASN1EncodableVector();
