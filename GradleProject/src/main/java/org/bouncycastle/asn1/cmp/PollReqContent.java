...
public class PollReqContent extends ASN1Object {
    ...
    public static ASN1Integer[] intsToASN1(BigInteger[] bigIntegerArr) {
    ...
    public static DERSequence[] intsToSequence(ASN1Integer[] aSN1IntegerArr) {
    ...
    public static ASN1Integer[] sequenceToASN1IntegerArray(ASN1Sequence aSN1Sequence) {
