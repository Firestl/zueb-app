...
public class ECDSAPublicKey extends PublicKeyDataObject {
    ...
    public byte[] basePointG;
    public BigInteger cofactorF;
    public BigInteger firstCoefA;
    public int options;
    public BigInteger orderOfBasePointR;
    public BigInteger primeModulusP;
    public byte[] publicPointY;
    public BigInteger secondCoefB;
    public ASN1ObjectIdentifier usage;
