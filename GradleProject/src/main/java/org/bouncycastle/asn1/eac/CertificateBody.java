...
public class CertificateBody extends ASN1Object {
    ...
    public static final int CEfD = 32;
    public static final int CExD = 64;
    public static final int CHA = 16;
    ...
    public ASN1ApplicationSpecific certificateEffectiveDate;
    public ASN1ApplicationSpecific certificateExpirationDate;
    public CertificateHolderAuthorization certificateHolderAuthorization;
    public ASN1ApplicationSpecific certificateHolderReference;
    public ASN1ApplicationSpecific certificateProfileIdentifier;
    public int certificateType = 0;
    public ASN1ApplicationSpecific certificationAuthorityReference;
    public PublicKeyDataObject publicKey;
