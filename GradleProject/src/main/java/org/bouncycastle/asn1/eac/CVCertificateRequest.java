...
public class CVCertificateRequest extends ASN1Object {
    public static final int bodyValid = 1;
    public static final int signValid = 2;
    public CertificateBody certificateBody;
    public byte[] innerSignature = null;
    public final ASN1ApplicationSpecific original;
    public byte[] outerSignature;
