...
public interface SECObjectIdentifiers {
    ...
    static {
        ...
        secp112r1 = ellipticCurve.branch(Constants.VIA_SHARE_TYPE_INFO);
        secp112r2 = ellipticCurve.branch("7");
        secp160r1 = ellipticCurve.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        secp160k1 = ellipticCurve.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        secp256k1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        sect163r2 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
        sect283k1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_START_WAP);
        sect283r1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        sect131r1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        sect131r2 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
        sect193r1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_CHAT_AIO);
        sect193r2 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_CHAT_AUDIO);
        sect233k1 = ellipticCurve.branch(Constants.VIA_REPORT_TYPE_CHAT_VIDEO);
        sect233r1 = ellipticCurve.branch("27");
        secp128r1 = ellipticCurve.branch(Constants.VIA_ACT_TYPE_TWENTY_EIGHT);
