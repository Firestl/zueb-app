...
public interface OCSPObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_pkix_ocsp_pref_sig_algs = id_pkix_ocsp.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
    public static final ASN1ObjectIdentifier id_pkix_ocsp_extended_revoke = id_pkix_ocsp.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
}
