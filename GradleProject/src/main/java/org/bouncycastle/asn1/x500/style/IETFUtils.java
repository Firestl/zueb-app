...
public class IETFUtils {
    public static void appendRDN(StringBuffer stringBuffer, RDN rdn, Hashtable hashtable) {
        ...
        for (int i = 0; i != typesAndValues.length; i++) {
            if (z) {
                ...
                stringBuffer.append(FunctionParser.Lexer.PLUS);
            }
    ...
    public static int convertHex(char c) {
        if ('0' > c || c > '9') {
            return (('a' > c || c > 'f') ? c - 'A' : c - FunctionParser.Lexer.A_LOWER) + 10;
        }
        return c - '0';
    }
    ...
    public static RDN[] rDNsFromString(String str, X500NameStyle x500NameStyle) {
        ...
        while (x500NameTokenizer.hasMoreTokens()) {
            ...
            if (strNextToken.indexOf(43) > 0) {
                X500NameTokenizer x500NameTokenizer2 = new X500NameTokenizer(strNextToken, FunctionParser.Lexer.PLUS);
    ...
    public static String stripInternalSpaces(String str) {
        if (str.indexOf(GlideException.IndentedAppendable.INDENT) < 0) {
            return str;
        }
