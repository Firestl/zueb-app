...
public class PKIData extends ASN1Object {
    public final TaggedContentInfo[] cmsSequence;
    public final TaggedAttribute[] controlSequence;
    public final OtherMsg[] otherMsgSequence;
    public final TaggedRequest[] reqSequence;
