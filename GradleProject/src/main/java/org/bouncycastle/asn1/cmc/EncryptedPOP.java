...
public class EncryptedPOP extends ASN1Object {
    public final ContentInfo cms;
    public final TaggedRequest request;
    public final AlgorithmIdentifier thePOPAlgID;
    public final byte[] witness;
    public final AlgorithmIdentifier witnessAlgID;
