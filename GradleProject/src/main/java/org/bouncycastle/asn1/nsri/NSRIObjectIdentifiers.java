...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_sea = aSN1ObjectIdentifierBranch.branch("1");
        ...
        id_aria192_ecb = id_sea.branch(Constants.VIA_SHARE_TYPE_INFO);
        id_aria192_cbc = id_sea.branch("7");
        id_aria192_cfb = id_sea.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        id_aria192_ofb = id_sea.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        id_aria192_ctr = id_sea.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        id_aria256_ecb = id_sea.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        id_aria256_cbc = id_sea.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        id_aria256_cfb = id_sea.branch("13");
        id_aria256_ofb = id_sea.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        id_aria256_ctr = id_sea.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
        id_aria128_cmac = id_sea.branch("21");
        id_aria192_cmac = id_sea.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        id_aria256_cmac = id_sea.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
