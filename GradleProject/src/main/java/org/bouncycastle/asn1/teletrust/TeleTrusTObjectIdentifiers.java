...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = teleTrusTAlgorithm.branch("3.1");
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = teleTrusTAlgorithm.branch("3.2");
        ecSign = aSN1ObjectIdentifierBranch2;
        ecSignWithSha1 = aSN1ObjectIdentifierBranch2.branch("1");
        ecSignWithRipemd160 = ecSign.branch("2");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = teleTrusTAlgorithm.branch("3.2.8");
        ...
        brainpoolP224t1 = versionOne.branch(Constants.VIA_SHARE_TYPE_INFO);
        brainpoolP256r1 = versionOne.branch("7");
        brainpoolP256t1 = versionOne.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        brainpoolP320r1 = versionOne.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        brainpoolP320t1 = versionOne.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        brainpoolP384r1 = versionOne.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        brainpoolP384t1 = versionOne.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        brainpoolP512r1 = versionOne.branch("13");
        brainpoolP512t1 = versionOne.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
    }
}
