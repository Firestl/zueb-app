...
public interface UAObjectIdentifiers {
    ...
    static {
        ...
        dstu7564digest_256 = UaOid.branch("1.2.2.1");
        dstu7564digest_384 = UaOid.branch("1.2.2.2");
        dstu7564digest_512 = UaOid.branch("1.2.2.3");
        dstu7564mac_256 = UaOid.branch("1.2.2.4");
        dstu7564mac_384 = UaOid.branch("1.2.2.5");
        dstu7564mac_512 = UaOid.branch("1.2.2.6");
        dstu7624ecb_128 = UaOid.branch("1.1.3.1.1");
        dstu7624ecb_256 = UaOid.branch("1.1.3.1.2");
        dstu7624ecb_512 = UaOid.branch("1.1.3.1.3");
        dstu7624ctr_128 = UaOid.branch("1.1.3.2.1");
        dstu7624ctr_256 = UaOid.branch("1.1.3.2.2");
        dstu7624ctr_512 = UaOid.branch("1.1.3.2.3");
        dstu7624cfb_128 = UaOid.branch("1.1.3.3.1");
        dstu7624cfb_256 = UaOid.branch("1.1.3.3.2");
        dstu7624cfb_512 = UaOid.branch("1.1.3.3.3");
        dstu7624cmac_128 = UaOid.branch("1.1.3.4.1");
        dstu7624cmac_256 = UaOid.branch("1.1.3.4.2");
        dstu7624cmac_512 = UaOid.branch("1.1.3.4.3");
        dstu7624cbc_128 = UaOid.branch("1.1.3.5.1");
        dstu7624cbc_256 = UaOid.branch("1.1.3.5.2");
        dstu7624cbc_512 = UaOid.branch("1.1.3.5.3");
        dstu7624ofb_128 = UaOid.branch("1.1.3.6.1");
        dstu7624ofb_256 = UaOid.branch("1.1.3.6.2");
        dstu7624ofb_512 = UaOid.branch("1.1.3.6.3");
        dstu7624gmac_128 = UaOid.branch("1.1.3.7.1");
        dstu7624gmac_256 = UaOid.branch("1.1.3.7.2");
        dstu7624gmac_512 = UaOid.branch("1.1.3.7.3");
        dstu7624ccm_128 = UaOid.branch("1.1.3.8.1");
        dstu7624ccm_256 = UaOid.branch("1.1.3.8.2");
        dstu7624ccm_512 = UaOid.branch("1.1.3.8.3");
        dstu7624xts_128 = UaOid.branch("1.1.3.9.1");
        dstu7624xts_256 = UaOid.branch("1.1.3.9.2");
        dstu7624xts_512 = UaOid.branch("1.1.3.9.3");
        dstu7624kw_128 = UaOid.branch("1.1.3.10.1");
        dstu7624kw_256 = UaOid.branch("1.1.3.10.2");
