...
public class AuthEnvelopedDataParser {
    public EncryptedContentInfoParser authEncryptedContentInfoParser;
    public ASN1Encodable nextObject;
    public boolean originatorInfoCalled;
    public ASN1SequenceParser seq;
