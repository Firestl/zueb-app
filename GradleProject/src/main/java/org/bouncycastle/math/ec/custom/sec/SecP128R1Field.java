...
public class SecP128R1Field {
    ...
    public static final int P3s1 = 2147483646;
    public static final int PExt7s1 = 2147483646;
    public static final int[] P = {-1, -1, -1, -3};
    public static final int[] PExt = {1, 0, 0, 4, -2, -1, 3, -4};
    public static final int[] PExtInv = {-1, -1, -1, -5, 1, 0, -4, 3};
