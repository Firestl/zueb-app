...
public class LongArray implements Cloneable {
    ...
    public static long interleave3(long j) {
        return (interleave3_21to63(((int) (j >>> 42)) & QTesla3p.PARAM_B) << 2) | (Long.MIN_VALUE & j) | interleave3_21to63(((int) j) & QTesla3p.PARAM_B) | (interleave3_21to63(((int) (j >>> 21)) & QTesla3p.PARAM_B) << 1);
    }
