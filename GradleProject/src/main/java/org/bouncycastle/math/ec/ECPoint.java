...
public abstract class ECPoint {
    ...
    public boolean implIsValid(final boolean z, final boolean z2) {
        ...
        return !((ValidityPrecompInfo) getCurve().precompute(this, ValidityPrecompInfo.PRECOMP_NAME, new PreCompCallback() { // from class: org.bouncycastle.math.ec.ECPoint.1
