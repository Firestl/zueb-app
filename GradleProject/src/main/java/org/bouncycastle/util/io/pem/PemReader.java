...
public class PemReader extends BufferedReader {
    ...
    private PemObject loadObject(String str) throws IOException {
        ...
        while (true) {
            ...
            if (line.indexOf(Constants.COLON_SEPARATOR) >= 0) {
    ...
    public PemObject readPemObject() throws IOException {
        ...
        if (line == null || (iIndexOf = (strSubstring = line.substring(11)).indexOf(45)) <= 0 || !strSubstring.endsWith(PemKeyType.MARKER) || strSubstring.length() - iIndexOf != 5) {
            return null;
        }
