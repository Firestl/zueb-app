...
public class SwitchCompat extends CompoundButton {
    ...
    public static final Property<SwitchCompat, Float> THUMB_POS = new a(Float.class, "thumbPos");
    ...
    private void applyThumbTint() {
        if (this.mThumbDrawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                Drawable drawableMutate = y8.i(this.mThumbDrawable).mutate();
                this.mThumbDrawable = drawableMutate;
                if (this.mHasThumbTint) {
                    y8.a(drawableMutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    y8.a(this.mThumbDrawable, this.mThumbTintMode);
                }
    ...
    private void applyTrackTint() {
        if (this.mTrackDrawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                Drawable drawableMutate = y8.i(this.mTrackDrawable).mutate();
                this.mTrackDrawable = drawableMutate;
                if (this.mHasTrackTint) {
                    y8.a(drawableMutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    y8.a(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    private int getThumbOffset() {
        return (int) (((v3.a(this) ? 1.0f - this.mThumbPosition : this.mThumbPosition) * getThumbScrollRange()) + 0.5f);
    }
    ...
    private int getThumbScrollRange() {
        ...
        Rect rectD = drawable2 != null ? y2.d(drawable2) : y2.c;
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        if (z) {
            ...
            } else if (!v3.a(this) ? xVelocity <= 0.0f : xVelocity >= 0.0f) {
    ...
    public void draw(Canvas canvas) {
        ...
        Rect rectD = drawable != null ? y2.d(drawable) : y2.c;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect rectD = y2.d(this.mThumbDrawable);
    ...
    */
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        boolean zIsChecked = isChecked();
        if (getWindowToken() != null && lb.M(this)) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        p3 p3VarA = p3.a(context, i, androidx.appcompat.R.styleable.TextAppearance);
        ColorStateList colorStateListA = p3VarA.a(androidx.appcompat.R.styleable.TextAppearance_android_textColor);
        if (colorStateListA != null) {
            this.mTextColors = colorStateListA;
        } else {
            this.mTextColors = getTextColors();
        }
        int iC = p3VarA.c(androidx.appcompat.R.styleable.TextAppearance_android_textSize, 0);
        if (iC != 0) {
            float f = iC;
        ...
        setSwitchTypefaceByIndex(p3VarA.d(androidx.appcompat.R.styleable.TextAppearance_android_typeface, -1), p3VarA.d(androidx.appcompat.R.styleable.TextAppearance_android_textStyle, -1));
        if (p3VarA.a(androidx.appcompat.R.styleable.TextAppearance_textAllCaps, false)) {
            this.mSwitchTransformationMethod = new g1(getContext());
        } else {
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(b1.c(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(b1.c(getContext(), i));
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        p3 p3VarA = p3.a(context, attributeSet, androidx.appcompat.R.styleable.SwitchCompat, i, 0);
        lb.a(this, context, androidx.appcompat.R.styleable.SwitchCompat, attributeSet, p3VarA.a(), i, 0);
        Drawable drawableB = p3VarA.b(androidx.appcompat.R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawableB;
        if (drawableB != null) {
            drawableB.setCallback(this);
        }
        Drawable drawableB2 = p3VarA.b(androidx.appcompat.R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawableB2;
        if (drawableB2 != null) {
            drawableB2.setCallback(this);
        }
        this.mTextOn = p3VarA.e(androidx.appcompat.R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = p3VarA.e(androidx.appcompat.R.styleable.SwitchCompat_android_textOff);
        this.mShowText = p3VarA.a(androidx.appcompat.R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = p3VarA.c(androidx.appcompat.R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = p3VarA.c(androidx.appcompat.R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = p3VarA.c(androidx.appcompat.R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = p3VarA.a(androidx.appcompat.R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateListA = p3VarA.a(androidx.appcompat.R.styleable.SwitchCompat_thumbTint);
        if (colorStateListA != null) {
            this.mThumbTintList = colorStateListA;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode modeA = y2.a(p3VarA.d(androidx.appcompat.R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList colorStateListA2 = p3VarA.a(androidx.appcompat.R.styleable.SwitchCompat_trackTint);
        if (colorStateListA2 != null) {
            this.mTrackTintList = colorStateListA2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode modeA2 = y2.a(p3VarA.d(androidx.appcompat.R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int iG = p3VarA.g(androidx.appcompat.R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (iG != 0) {
