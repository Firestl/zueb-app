...
public final class ViewStubCompat extends View {
    ...
    public View a() {
        ...
        View viewInflate = layoutInflaterFrom.inflate(this.f1205a, viewGroup, false);
        int i = this.b;
        if (i != -1) {
            viewInflate.setId(i);
        }
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f1205a = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ViewStubCompat_android_layout, 0);
