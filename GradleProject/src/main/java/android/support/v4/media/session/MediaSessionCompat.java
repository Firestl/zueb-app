...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((se) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            n7.a(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(se seVar) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(seVar);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            se currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(se seVar);
        ...
        void setPlaybackToRemote(we weVar);
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final se getCurrentControllerInfo() {
            return new se(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(se seVar) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public we.a mVolumeCallback = new we.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // supwisdom.we.a
            public void onVolumeChanged(we weVar) {
                if (MediaSessionImplBase.this.mVolumeProvider != weVar) {
                    return;
                }
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, weVar.c(), weVar.b(), weVar.a()));
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    we weVar = MediaSessionImplBase.this.mVolumeProvider;
                    if (i == 2) {
                        int iC = weVar.c();
                        int iB = weVar.b();
                        streamVolume = weVar.a();
                        streamMaxVolume = iB;
                        i3 = iC;
                    } else {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new se("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new se(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public se getCurrentControllerInfo() {
            se seVar;
            synchronized (this.mLock) {
                seVar = this.mRemoteUserInfo;
            }
            return seVar;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(we weVar) {
            if (weVar == null) {
                throw new IllegalArgumentException("volumeProvider may not be null");
            }
            we weVar2 = this.mVolumeProvider;
            if (weVar2 != null) {
                weVar2.a((we.a) null);
            }
            this.mVolumeType = 2;
            this.mVolumeProvider = weVar;
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(n7.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                n7.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public void setPlaybackToRemote(we weVar) {
        ...
        this.mImpl.setPlaybackToRemote(weVar);
    }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new se(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(we weVar) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, weVar.d());
        }
