...
public class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
    ...
    public AnimatorEventListener mAnimatorEventListener = new AnimatorEventListener(this, null);
    public ArrayList<NameValuesHolder> mPendingAnimations = new ArrayList<>();
    public Runnable mAnimationStarter = new Runnable() { // from class: io.dcloud.nineoldandroids.view.ViewPropertyAnimatorPreHC.1
