...
public class AndroidMediaController extends MediaController implements IMediaController {
    ...
    @Override // android.widget.MediaController, io.dcloud.media.video.ijkplayer.media.IMediaController
    public void hide() {
        super.hide();
    ...
    @Override // io.dcloud.media.video.ijkplayer.media.IMediaController
