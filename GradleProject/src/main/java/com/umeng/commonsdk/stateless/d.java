...
public class d {
            ...
            try {
                synchronized (b) {
                    try {
                        ...
                        File file = new File(context.getFilesDir() + "/" + a.f5412e);
                        if (!file.isDirectory()) {
                            file.mkdir();
                        }
    ...
    public static String d(String str) {
        int iLastIndexOf;
        int iLastIndexOf2;
        return (!TextUtils.isEmpty(str) && str.indexOf("envelope") < 0 && (iLastIndexOf = str.lastIndexOf("_")) >= 0 && (iLastIndexOf2 = str.lastIndexOf(Operators.DOT_STR)) >= 0) ? str.substring(iLastIndexOf + 1, iLastIndexOf2) : "";
    }
  ...
  0x0065: PHI (r1v2 java.io.FileOutputStream) = (r1v1 java.io.FileOutputStream), (r1v3 java.io.FileOutputStream) binds: [B:22:0x0063, B:27:0x006d] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    ...
    */
        ...
        try {
            synchronized (b) {
                ...
                if (context != null && context.getApplicationContext() != null) {
                    String str = context.getApplicationContext().getFilesDir() + File.separator + a.f5412e;
                    if (!TextUtils.isEmpty(str)) {
    ...
    public static String a(Context context, boolean z) {
        ...
        try {
            if (z) {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f5412e;
            } else {
