...
public class u {
    ...
    public static final String f5314a = "fs_lc_tl_uapp";
    ...
    private void b(Context context) {
        try {
            String string = PreferenceWrapper.getDefault(context).getString(f5314a, null);
    ...
    private void c(Context context) {
        try {
            if (this.h != null) {
                PreferenceWrapper.getDefault(g).edit().putString(f5314a, this.h.toString()).commit();
            }
        ...
        try {
            ...
            if (b(map)) {
                ...
                if (!z) {
                    ...
                    UMWorkDispatch.sendEvent(g, q.a.n, CoreProtocol.getInstance(g), jSONObject);
                }
            }
        } catch (Throwable unused2) {
        }
    ...
    private void a() {
        try {
            ...
            String[] strArrSplit = strImprintProperty.split(Operators.AND_NOT);
            JSONObject jSONObject = new JSONObject();
            int i = 0;
            if (this.h != null) {
