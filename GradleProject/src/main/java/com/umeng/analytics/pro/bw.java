...
public final class bw {
    ...
    public static final Comparator f5218a = new a();
    ...
    public static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            return obj instanceof List ? bw.a((List) obj, (List) obj2) : obj instanceof Set ? bw.a((Set) obj, (Set) obj2) : obj instanceof Map ? bw.a((Map) obj, (Map) obj2) : obj instanceof byte[] ? bw.a((byte[]) obj, (byte[]) obj2) : bw.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static int a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int iCompare = f5218a.compare(list.get(i), list2.get(i));
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        TreeSet treeSet = new TreeSet(f5218a);
        treeSet.addAll(set);
        TreeSet treeSet2 = new TreeSet(f5218a);
        treeSet2.addAll(set2);
        Iterator it = treeSet.iterator();
        Iterator it2 = treeSet2.iterator();
        while (it.hasNext() && it2.hasNext()) {
            int iCompare = f5218a.compare(it.next(), it2.next());
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        TreeMap treeMap = new TreeMap(f5218a);
        treeMap.putAll(map);
        Iterator it = treeMap.entrySet().iterator();
        TreeMap treeMap2 = new TreeMap(f5218a);
        treeMap2.putAll(map2);
        Iterator it2 = treeMap2.entrySet().iterator();
        while (it.hasNext() && it2.hasNext()) {
            Map.Entry entry = (Map.Entry) it.next();
            Map.Entry entry2 = (Map.Entry) it2.next();
            int iCompare = f5218a.compare(entry.getKey(), entry2.getKey());
            if (iCompare != 0) {
                return iCompare;
            }
            int iCompare2 = f5218a.compare(entry.getValue(), entry2.getValue());
            if (iCompare2 != 0) {
                return iCompare2;
            }
        }
