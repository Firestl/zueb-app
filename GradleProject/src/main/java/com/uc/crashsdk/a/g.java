...
public class g {
    ...
    public static final /* synthetic */ boolean f5113a = !g.class.desiredAssertionStatus();
    public static String c = null;
    public static String d = null;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static String f5114e = null;
    public static String f = null;
    public static String g = null;
    public static boolean h = false;
    public static final Object i = new Object();
    public static final char[] j = {'0', '1', '2', '3', '4', '5', '6', '7', '8', FunctionParser.Lexer.NINE, FunctionParser.Lexer.A_LOWER, 'b', 'c', 'd', 'e', 'f'};
    ...
    public static boolean g() {
        ...
        if (!a(strI) && (iIndexOf = strI.indexOf(" root ")) > 0) {
            ...
            if (strSubstring.contains(Constants.Name.X) || strSubstring.contains("s")) {
                return true;
            }
        }
        return false;
