...
public class DimRequest implements Parcelable {
    ...
    public String toString() {
        return "DimRequest{key='" + this.key + Operators.SINGLE_QUOTE + ", ramCacheValidTime=" + this.ramCacheValidTime + ", storageCacheValidTime=" + this.storageCacheValidTime + ", allowSysCall=" + this.allowSysCall + ", useExpiredCacheForReserve=" + this.useExpiredCacheForReserve + ", caller=" + this.caller + Operators.BLOCK_END;
    }
