...
public class SdkLoader {
    public static void load(Context context, String str, String str2, String str3, String str4, String str5) throws Throwable {
        try {
            ...
            if (file.exists()) {
                ...
                if (file2.exists()) {
                    File file3 = new File(str2, file.getName().replace(com.getui.gtc.c.a.b, com.getui.gtc.c.a.f2139a));
                    if (file3.exists()) {
                        file3.delete();
                    }
            ...
            if (file4.exists()) {
                File file5 = new File(str2, file4.getName().replace(com.getui.gtc.c.a.b, com.getui.gtc.c.a.f2139a));
                if (file5.exists()) {
