...
public class SdkInfo implements Parcelable {
    ...
    public static class Builder {
        ...
        public String moduleName;
        public String psUrl;
        public List<a.C0044a> stubs = new ArrayList();
        public String version;
    ...
    public SdkInfo(Parcel parcel) {
        ...
        parcel.readTypedList(arrayList, a.C0044a.CREATOR);
    }
    ...
    public void setStubs(List<a.C0044a> list) {
        this.stubs = list;
    }
