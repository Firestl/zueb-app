...
public final class b {
    ...
    public static Map<String, String> a(long j, final d dVar) {
        final String server = ServerManager.getServer("gtc.cs");
        return com.getui.gtc.f.a.a(GtcProvider.context(), new c.a().b("GTC").a(String.format("%s/api.php?format=json&t=1", server)).c(com.getui.gtc.c.b.f2140a).d(com.getui.gtc.c.b.d).e(BuildConfig.VERSION_NAME).a(j).a(new d() { // from class: com.getui.gtc.f.b.1
    ...
    public static Map<String, String> a(SdkInfo sdkInfo, final a aVar) {
        return com.getui.gtc.f.a.a(GtcProvider.context(), new c.a().a(TextUtils.isEmpty(sdkInfo.getPsUrl()) ? String.format("%s/api.php?format=json&t=1", ServerManager.getServer("gtc.cs")) : sdkInfo.getPsUrl()).b(sdkInfo.getModuleName()).d(sdkInfo.getCid()).e(sdkInfo.getVersion()).c(sdkInfo.getAppid()).a(43200000L).a(new d() { // from class: com.getui.gtc.f.b.2
            @Override // com.getui.gtc.f.d
            public final void a(Exception exc) {
            }
