...
public class HttpHeaders implements Serializable {
    ...
    public static String getUserAgent() {
        ...
        String string = null;
        try {
            string = fv0.i().e().getString(((Integer) Class.forName("com.android.internal.R$string").getDeclaredField("web_user_agent").get(null)).intValue());
        ...
        if (language != null) {
            ...
            stringBuffer.append(LocaleManager.DEFAULT_LANGUAGE);
        }
    ...
    public String toString() {
        return "HttpHeaders{headersMap=" + this.headersMap + Operators.BLOCK_END;
    }
