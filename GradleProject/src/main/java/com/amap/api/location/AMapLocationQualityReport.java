...
public class AMapLocationQualityReport implements Cloneable {
    ...
    public String f1644e = GrsBaseInfo.CountryCodeSource.UNKNOWN;
    public long f = 0;
    public boolean g = false;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public AMapLocationClientOption.AMapLocationMode f1643a = AMapLocationClientOption.AMapLocationMode.Hight_Accuracy;

    /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
    public AMapLocationQualityReport m3clone() {
        ...
        try {
            ...
            aMapLocationQualityReport.setNetworkType(this.f1644e);
            aMapLocationQualityReport.setLocationMode(this.f1643a);
    ...
    */
    public java.lang.String getAdviseMessage() {
        /*
            ...
            r0.<init>()
            com.amap.api.location.AMapLocationClientOption$AMapLocationMode r1 = r4.f1643a
