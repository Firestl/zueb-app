...
public class SFFileProvider extends ContentProvider {
    ...
    public static a b(Context context, String str) {
        b bVar = new b(str);
        XmlResourceParser xmlResourceParserLoadXmlMetaData = context.getPackageManager().resolveContentProvider(str, 128).loadXmlMetaData(context.getPackageManager(), androidx.core.content.FileProvider.META_DATA_FILE_PROVIDER_PATHS);
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f3872a = a(context, providerInfo.authority);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f3872a.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File fileA = this.f3872a.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) {
        return ParcelFileDescriptor.open(this.f3872a.a(uri), a(str));
    }
    ...
    public static class b implements a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final HashMap<String, File> f3873a = new HashMap<>();
        ...
        public void a(String str, File file) {
            ...
            try {
                this.f3873a.put(str, file.getCanonicalFile());
            } catch (IOException e2) {
                throw new IllegalArgumentException("Failed to resolve canonical path for " + file, e2);
            }
        }

        @Override // com.sangfor.atrust.appStore.SFFileProvider.a
        public File a(Uri uri) {
            String encodedPath = uri.getEncodedPath();
            int iIndexOf = encodedPath.indexOf(47, 1);
            String strDecode = Uri.decode(encodedPath.substring(1, iIndexOf));
            String strDecode2 = Uri.decode(encodedPath.substring(iIndexOf + 1));
            File file = this.f3873a.get(strDecode);
            if (file != null) {
