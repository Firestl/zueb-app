...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback, Animatable, ph {
    public static final int GRAVITY = 119;
    public static final int LOOP_FOREVER = -1;
    public static final int LOOP_INTRINSIC = 0;
    public List<ph.a> animationCallbacks;
    ...
    private void notifyAnimationEndToListeners() {
        List<ph.a> list = this.animationCallbacks;
        if (list != null) {
            int size = list.size();
    ...
    public void registerAnimationCallback(ph.a aVar) {
        if (aVar == null) {
            return;
        }
    ...
    public boolean unregisterAnimationCallback(ph.a aVar) {
        List<ph.a> list = this.animationCallbacks;
