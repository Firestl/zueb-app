...
public class MultiModelLoader<Model, Data> implements ModelLoader<Model, Data> {
    public final ka<List<Throwable>> exceptionListPool;
    ...
    public static class MultiFetcher<Data> implements DataFetcher<Data>, DataFetcher.DataCallback<Data> {
        ...
        public MultiFetcher(List<DataFetcher<Data>> list, ka<List<Throwable>> kaVar) {
    ...
    public MultiModelLoader(List<ModelLoader<Model, Data>> list, ka<List<Throwable>> kaVar) {
        this.modelLoaders = list;
        this.exceptionListPool = kaVar;
    }
