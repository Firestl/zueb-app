...
public class PushTaskBean {
    ...
    public List<BaseActionBean> actionChains;
    public String appid;
    ...
    public byte[] msgExtra;
    public int perActionid;
    public int status;
    public String taskId;
    public String appKey = "";
    public boolean isHttpImg = false;
    ...
    public void parse(JSONObject jSONObject) throws JSONException {
        if (jSONObject.has("appid") && jSONObject.get("appid").equals(e.f3403a)) {
