...
public class PushService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        if (!type.startsWith("GB-") && !type.startsWith("PB-")) {
            return c.f3185a.equals(type) ? d.a().f3189a.getBinder() : type.startsWith("GTC-") ? ServiceManager.getInstance().a((Service) this, intent) : ServiceManager.getInstance().a((Service) this, intent);
        }
    ...
    public void onDestroy() {
        ...
        IPushCore iPushCore = serviceManager.f3294a;
        if (iPushCore != null) {
