...
public final class f extends com.vivo.push.l {
    ...
    public final void a(com.vivo.push.o oVar) {
        if (this.f5616a.getPackageName().equals(com.vivo.push.util.s.b(this.f5616a))) {
            return;
        }
        com.vivo.push.b.j jVar = (com.vivo.push.b.j) oVar;
        int iD = jVar.d();
        int iE = jVar.e();
        com.vivo.push.util.o.d("OnChangePushStatusTask", "OnChangePushStatusTask serviceStatus is " + iD + " ; receiverStatus is " + iE);
        if (iD == 2) {
            b(this.f5616a);
        } else if (iD == 1) {
            a(this.f5616a);
