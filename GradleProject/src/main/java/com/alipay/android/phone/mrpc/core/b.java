...
public final class b implements HttpClient {
    ...
    public RuntimeException f1555e = new IllegalStateException("AndroidHttpClient created and never closed");
    public volatile C0008b f;
    ...
    public class a implements HttpRequestInterceptor {
        ...
        public final void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0008b c0008b = b.this.f;
            if (c0008b != null && C0008b.a(c0008b) && (httpRequest instanceof HttpUriRequest)) {
                C0008b.a(c0008b, b.a((HttpUriRequest) httpRequest));
            }
        }
    }
    ...
    public static class C0008b {
        ...
        public static /* synthetic */ void a(C0008b c0008b, String str) {
            Log.println(c0008b.b, c0008b.f1557a, str);
        }

        public static /* synthetic */ boolean a(C0008b c0008b) {
            return Log.isLoggable(c0008b.f1557a, c0008b.b);
        }
    }
