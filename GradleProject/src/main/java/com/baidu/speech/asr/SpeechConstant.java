...
public class SpeechConstant {
    ...
    public static final String ASR_ENABLE_NUMBERFORMAT = "enable.numberformat";
    ...
    public static final String ASR_PUNCTUATION_MODE = "punctuation-mode";
    ...
    public static final String LMID = "lm_id";
