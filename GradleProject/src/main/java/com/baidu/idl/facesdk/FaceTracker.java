...
public class FaceTracker {
    ...
    public ErrCode faceVerification(int[] iArr, int i, int i2, FaceSDK.ImgType imgType, ActionType actionType) {
        ...
        int iPrepare_data_for_verify = prepare_data_for_verify(iArr, i, i2, imgType.ordinal(), actionType.ordinal());
        return iPrepare_data_for_verify == ErrCode.OK.ordinal() ? ErrCode.OK : iPrepare_data_for_verify > 0 ? ErrCode.values()[iPrepare_data_for_verify] : ErrCode.UNKNOW_TYPE;
    }
    ...
    public ErrCode maxFaceVerification(int[] iArr, int i, int i2, FaceSDK.ImgType imgType, ActionType actionType) {
        ...
        int iPrepare_max_face_data_for_verify = prepare_max_face_data_for_verify(iArr, i, i2, imgType.ordinal(), actionType.ordinal());
        return iPrepare_max_face_data_for_verify == ErrCode.OK.ordinal() ? ErrCode.OK : iPrepare_max_face_data_for_verify > 0 ? ErrCode.values()[iPrepare_max_face_data_for_verify] : ErrCode.UNKNOW_TYPE;
    }
