...
public final class FaceDetectStrategyExtModule extends FaceStrategyModule implements IDetectStrategy {
    ...
    public volatile boolean mIsPlayCompletion;
    ...
    public void processUIResult(FaceModel faceModel) throws Throwable {
        ...
        if (this.mIsProcessing) {
            ...
            if (faceStatusEnumCheckDetect == FaceStatusEnum.OK || faceStatusEnumCheckDetect == FaceStatusEnum.Detect_DataNotReady) {
    ...
    public void detectStrategy(byte[] bArr) throws Throwable {
