...
public class GifAnimationMetaData implements Serializable, Parcelable {
    ...
    public final long mMetadataBytesCount;
    public final long mPixelsBytesCount;
    ...
    public long getDrawableAllocationByteCount(GifDrawable gifDrawable, int i) {
        if (i >= 1 && i <= 65535) {
            int i2 = i * i;
            return (this.mPixelsBytesCount / ((long) i2)) + ((long) ((gifDrawable == null || gifDrawable.mBuffer.isRecycled()) ? ((this.mWidth * this.mHeight) * 4) / i2 : Build.VERSION.SDK_INT >= 19 ? gifDrawable.mBuffer.getAllocationByteCount() : gifDrawable.getFrameByteCount()));
        }
        throw new IllegalStateException("Sample size " + i + " out of range <1, \uffff" + Operators.G);
    }
