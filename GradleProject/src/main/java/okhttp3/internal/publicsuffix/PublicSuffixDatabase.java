...
import supwisdom.yu1;

/* JADX INFO: loaded from: classes3.dex */
public final class PublicSuffixDatabase {

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final byte[] f6787e = {42};
    public static final String[] f = new String[0];
    public static final String[] g = {Operators.MUL};
    public static final PublicSuffixDatabase h = new PublicSuffixDatabase();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final AtomicBoolean f6788a = new AtomicBoolean(false);
        ...
        while (true) {
            try {
                try {
                    ...
                    yu1.c().a(5, "Failed to read public suffix list", e2);
                    if (z) {
    ...
    public final String[] a(String[] strArr) {
        ...
        String[] strArrSplit2;
        int i = 0;
        if (!this.f6788a.get() && this.f6788a.compareAndSet(false, true)) {
            b();
        } else {
            try {
                this.b.await();
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            bArr[i2] = strArr[i2].getBytes(kt1.i);
        }
        int i3 = 0;
        while (true) {
            str = null;
        ...
        while (i5 < length) {
            ...
            if (i4 >= 0) {
                if (i4 <= 0) {
                    ...
                    if (length2 >= i13) {
                        if (length2 <= i13) {
                            return new String(bArr, i7, i9, kt1.i);
                        }
                    }
                }
                i5 = i2 + 1;
    ...
    public final void a() throws IOException {
        InputStream resourceAsStream = PublicSuffixDatabase.class.getResourceAsStream(dc.squareup.okhttp3.internal.publicsuffix.PublicSuffixDatabase.PUBLIC_SUFFIX_RESOURCE);
