...
public class InputSurface {
    ...
    private void eglSetup() {
        ...
        if (!EGL14.eglChooseConfig(this.mEGLDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, QTesla3p.CRYPTO_SECRETKEYBYTES, 4, EGL_RECORDABLE_ANDROID, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
